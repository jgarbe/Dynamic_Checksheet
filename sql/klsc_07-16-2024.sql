...
CREATE TABLE IF NOT EXISTS `Rescue3_EZ_IO` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `item_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL,
  `subcategory_id` int(11) NOT NULL,
...
INSERT INTO `Rescue3_EZ_IO` (`id`, `item_id`, `category_id`, `subcategory_id`, `hm_value_id`, `req`, `T_update`) VALUES
...
CREATE TABLE IF NOT EXISTS `Rescue3_EZ_IO_checksheet` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `event_id` int(11) DEFAULT NULL,
  `item_id` int(11) DEFAULT NULL,
  `result` varchar(11) DEFAULT NULL,
...
INSERT INTO `Rescue3_EZ_IO_checksheet` (`id`, `event_id`, `item_id`, `result`, `hm_value_id`, `category_id`, `subcategory_id`) VALUES
(1, 1, 509, '1', 'cb', 3, 1),
(2, 1, 118, '1', 'cb', 3, 1),
(3, 1, 55, '1', 'cb', 3, 1),
(4, 1, 41, '1', 'cb', 3, 1),
...
CREATE TABLE IF NOT EXISTS `Rescue3_EZ_IO_events` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `date` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
...
INSERT INTO `Rescue3_EZ_IO_events` (`id`, `date`, `submitted`, `merged`, `merger`) VALUES
...
-- Dump completed on 2024-07-16 18:28:14
