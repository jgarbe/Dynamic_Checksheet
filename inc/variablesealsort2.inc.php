...
//**************************************************************************************//
	...
	require_once('setsealsql.inc.php'); // bring in the functions.
function variablesealsort($Checksheetno,$casc_id,$value,$sitem,$name,$q_set,$cat,$sub)	{ 
...
switch($value){
	...
	case "cb":
		$variable=1;
		setsealsql($casc_id,$value,$sitem,$name,$variable,$q_set,$cat,$sub);
		echo "\n\n<!--checkbox-->\n\t<td><div class=chbox>\n";
...
print("</select>	\n");
 ...
 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	case "na":  ////////if it's an na type,...
        ...
        print("</div><div id=\"".$casc_id."[".$sitem."]\"></div></td> ");
...
echo "<input type=\"text\" name=\"".$cat.":".$sub.":".$sitem."\" size=\"4\"  id = \"".$Checksheetno.":".$casc_id.":".$value.":".$sitem.":".$name.":".$q_set.":".$cat.":".$sub."\"></div></td>\n";		 
	...
	case "irrg": /////////// If it's the irrigating solution divided by 500,..
		...
		echo "           <option VALUE=\"".$Checksheetno.":".$casc_id.":".$value.":".$sitem.":".$name.":".$q_set.":".$cat.":".$sub.":0\">0cc</option>\n</select>\n";
